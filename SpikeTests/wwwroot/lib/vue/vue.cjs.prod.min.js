...
function compileToFunction(e, r) {
  if (!shared.isString(e)) {
    if (!e.nodeType) return shared.NOOP;
    e = e.innerHTML;
  }
  var t = e,
    o = compileCache[t];
  if (o) return o;
  "#" === e[0] && (e = (o = document.querySelector(e)) ? o.innerHTML : "");
  const n = shared.extend(
    { hoistStatic: !0, onError: void 0, onWarn: shared.NOOP },
    r
  );
  n.isCustomElement ||
    "undefined" == typeof customElements ||
    (n.isCustomElement = (e) => !!customElements.get(e));
  o = compilerDom.compile(e, n).code;
  const i = new Function("Vue", o)(runtimeDom__namespace);
