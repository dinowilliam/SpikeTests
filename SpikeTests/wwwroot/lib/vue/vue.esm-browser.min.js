...
function createSuspenseBoundary(e, t, n, r, o, s, i, c, p, a, l = !1) {
  ...
  a = e.props ? toNumber(e.props.timeout) : void 0;
  assertNumber(a, "Suspense timeout");
  const v = {
    vnode: e,
    parent: t,
    parentComponent: n,
...
const isKeepAlive = (e) => e.type.__isKeepAlive,
  KeepAliveImpl = {
    ...
    setup(a, { slots: l }) {
      ...
      function h(e) {
        var t = c.get(e);
        u && isSameVNodeType(t, u) ? u && resetShapeFlag(u) : s(t),
          c.delete(e),
          p.delete(e);
      }
...
function applyOptions(e) {
  ...
  if (((shouldCacheAccess = !0), s))
    for (const k in s) {
      ...
      var T = isFunction(I)
          ...
          : NOOP,
        $ =
          (T === NOOP && warn(`Computed property "${k}" has no getter.`),
  ...
  if (
    ...
    _(onErrorCaptured, L),
    _(onRenderTracked, B),
    _(onRenderTriggered, H),
    _(onBeforeUnmount, F),
    _(onUnmounted, D),
    _(onServerPrefetch, j),
    isArray(y))
  )
    if (y.length) {
...
function mergeWatchOptions(e, t) {
  ...
  for (const r in t) n[r] = mergeAsArray$1(e[r], t[r]);
  return n;
}
...
function validateProp(e, n, t, r) {
  ...
  if (s && r) warn('Missing required prop: "' + e + '"');
    ...
    if (null != o && !0 !== o) {
      ...
      if (!t) return void warn(getInvalidTypeMessage(e, n, p));
    }
    i &&
      !i(n) &&
  ...
  const n = getGlobalThis(),
    ...
    O = (
      ...
      if (r !== o) {
        ...
        const { type: N, ref: k, shapeFlag: I } = o;
        switch (N) {
          case Text:
            var e = r,
              t = o,
              n = s,
              d = i;
            if (e == null) B((t.el = H(t.children)), n, d);
            else {
              const A = (t.el = e.el);
              if (t.children !== e.children) L(A, t.children);
            }
            break;
          case Comment:
            U(r, o, s, i);
          ...
          case Static:
            if (null == r)
              (n = o),
                ...
                (e = i),
                (t = c),
                ([n.el, n.anchor] = $(n.children, d, e, t, n.el, n.anchor));
            else {
              var f = r,
                m = o,
                h = s,
              ...
              if (m.children !== f.children) {
                const P = j(f.anchor);
                W(f);
                [m.el, m.anchor] = $(m.children, h, P, g);
              } else {
                m.el = f.el;
                m.anchor = f.anchor;
              }
          ...
          case Fragment:
            {
              ...
              var S = p;
              var C = u;
              const M = (g.el = h ? h.el : H("")),
                V = (g.anchor = h ? h.anchor : H(""));
          ...
          default:
            if (1 & I) {
              ...
              64 & I || 128 & I
                ? N.process(r, o, s, i, a, l, c, p, u, Z)
                : warn("Invalid VNode type:", N, `(${typeof N})`);
        }
        null != k && a && setRef(k, r && r.ref, l, o || r, !o);
      }
    },
    U = (e, t, n, r) => {
        ...
        null == e
          ? ((E = t.el = g("teleport start")),
            ...
            E
              ...
              : b ||
                warn("Invalid Teleport target on mount:", E, `(${typeof E})`),
            (y = (e, t) => {
...
function patchStyle(e, t, n) {
  ...
  if (n && !o) {
    if (t && !isString(t))
      for (const i in t) null == n[i] && setStyle(r, i, "");
    for (const a in n) setStyle(r, a, n[a]);
  } else {
    var s = r.display;
...
function resolveTransitionProps(e) {
  ...
  return extend(t, {
    onBeforeEnter(e) {
      callHook(v, [e]), addTransitionClass(e, i), addTransitionClass(e, o);
    },
    onBeforeAppear(e) {
      callHook(b, [e]), addTransitionClass(e, l), addTransitionClass(e, c);
    },
    onEnter: m(!1),
    onAppear: m(!0),
    onLeave(e, t) {
...
function getTransitionInfo(e, t) {
  ...
  var e = (e) => (n[e] || "").split(", "),
    r = e(TRANSITION$1 + "Delay"),
    o = e(TRANSITION$1 + "Duration"),
    r = getTimeout(r, o),
    s = e(ANIMATION + "Delay"),
  ...
  let a = null,
    ...
    c = 0;
  t === TRANSITION$1
    ? 0 < r && ((a = TRANSITION$1), (l = r), (c = o.length))
    : t === ANIMATION
    ? 0 < s && ((a = ANIMATION), (l = s), (c = i.length))
    : ((l = Math.max(r, s)),
      (a = 0 < l ? (s < r ? TRANSITION$1 : ANIMATION) : null),
      (c = a ? (a === TRANSITION$1 ? o : i).length : 0));
  t =
    a === TRANSITION$1 &&
    /\b(transform|all)(,|$)/.test(e(TRANSITION$1 + "Property").toString());
...
function generate(t, e = {}) {
  const n = createCodegenContext(t, e),
    ...
    p = Array.from(t.helpers);
  var e = 0 < p.length,
    u = !s && "module" !== r,
    d = n,
    d = (genFunctionPreamble(t, d), c ? "ssrRender" : "render");
  ...
  if (
    ...
    u &&
      ...
      i(),
      e &&
        (o(`const { ${p.map(aliasHelper).join(", ")} } = _Vue`),
        o(`
`),
        l())),
    t.components.length &&
...
function genNodeListAsArray(e, t) {
  var n = 3 < e.length || e.some((e) => isArray(e) || !isText(e));
  t.push("["),
    n && t.indent(),
    genNodeList(e, t, n),
    n && t.deindent(),
    ...
    if (6 === S.type) {
      ...
      "ref" === k &&
        ...
        ("is" === k &&
          ...
          l.push(
            createObjectProperty(
              createSimpleExpression(k, !0, getInnerRange(N, 0, k.length)),
              createSimpleExpression(I ? I.content : "", !0, I ? I.loc : N)
            )
          );
    } else {
...
function dedupeProperties(t) {
  ...
  for (let e = 0; e < t.length; e++) {
    ...
    8 !== i.key.type && i.key.isStatic
      ? ((o = i.key.content),
        (s = n.get(o))
          ? ("style" !== o && "class" !== o && !isOn(o)) || mergeAsArray(s, i)
          : (n.set(o, i), r.push(i)))
      : r.push(i);
  }
  return r;
...
const fnExpRE =
  ...
  seen$1 = new WeakSet(),
  transformOnce = (e, t) => {
    if (1 === e.type && findDir(e, "once", !0) && !seen$1.has(e) && !t.inVOnce)
      return (
        seen$1.add(e),
        (t.inVOnce = !0),
...
const DOMErrorMessages = {
  ...
  transformModel = (n, r, o) => {
    const s = transformModel$1(n, r, o);
  ...
  transformTransition = (n, r) => {
    if (
      1 === n.type &&
      1 === n.tagType &&
      r.isBuiltInComponent(n.tag) === TRANSITION
    )
      return () => {
...
function compileToFunction(n, e) {
  if (!isString(n)) {
    if (!n.nodeType) return warn("invalid template option: ", n), NOOP;
    n = n.innerHTML;
  }
  var t = n,
    r = compileCache[t];
  ...
  "#" === n[0] &&
    ((r = document.querySelector(n)) ||
      warn("Template element not found or is empty: " + n),
    (n = r ? r.innerHTML : ""));
